...
class ViewSubTask_Screen extends StatefulWidget{
  String taskId;
  String taskStatus;
  ViewSubTask_Screen(this.taskId,this.taskStatus);
  _viewSubTask createState()=>_viewSubTask();
}
class _viewSubTask extends State<ViewSubTask_Screen>{
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Align(
                ...
                child: TextButton(
                    ...
                    child: Container(
                      ...
                      height: 45,
                      width: 150,
                      child: const Center(child: Text("Add Sub Task",style: TextStyle(fontWeight: FontWeight.w900,fontSize: 16,color: Colors.white),),),
                    )
                ) ,
              ),
              ...
              SizedBox(height: 10,),
              taskList.isEmpty?
              Align(alignment: Alignment.center,child: Text("No Sub Task Available",style: TextStyle(fontSize: 17.5,color: AppTheme.orangeColor,fontWeight: FontWeight.w900),),):
              ListView.builder(
                  shrinkWrap: true,
                  ...
                  itemBuilder: (BuildContext cntx,int index){
                    ...
                    String taskStatus=widget.taskStatus;
  ...
  getSubTaskList() async{
    ...
    if (responseJSON['error'] == false) {
      totalTaskList.clear();
      totalTaskList=responseJSON['data'];
      taskList.clear();
