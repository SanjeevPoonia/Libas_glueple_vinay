...
import 'package:ChecklistTree/views/gluple/mh_attendance/mh_apply_leave_screen.dart';
...
import '../views/apply_attendance_correction_screen.dart';
import '../views/applytour_screen.dart';
import '../views/login_screen.dart';
class MH_AttendanceDetailsScreen extends StatefulWidget{
  _mhAttendanceDetails createState()=>_mhAttendanceDetails();
}
class _mhAttendanceDetails extends State<MH_AttendanceDetailsScreen>{
          ...
          children: [
            ...
            ListView.builder(
              ...
              itemBuilder: (BuildContext cntx,int index){
                ...
                print("Date:${attendanceDate[index].dateStr} && Status:${attendanceDate[index].attendanceStatus} && Total Time:${attendanceDate[index].totalTime}");
                ...
                if(attendanceDate[index].totalTime=="00:00:00"||attendanceDate[index].totalTime=="Invalid date"){
                  ...
                  if(workingHourText=="A" || workingHourText=="P" ){
                    showCorrectonDialog=false;
                  }
                }
                else{
                  ...
                  if(attendanceDate[index].attendanceStatus=="first_half_present"||attendanceDate[index].attendanceStatus=="FHP"){
                    ...
                    workingHourStatusText=attendanceDate[index].attendanceStatus;
                    workingHourColor=Colors.black;
                  }

                  if(workingHourStatusText=="A" || workingHourStatusText=="P" ){
                    showCorrectonDialog=false;
                  }
                }
                    ...
                    children: [
                      ...
                      InkWell(onTap: (){
                        isAttendanceLock?_showAttendanceBottomDialogForLock(attendanceDate[index].dateStr,attendanceDate[index].firstCheckIn,attendanceDate[index].lastCheckOut,attendanceDate[index].totalTime,workingHourText):
                            _showMHDialog(attendanceDate[index].dateStr,attendanceDate[index].firstCheckIn,attendanceDate[index].lastCheckOut,attendanceDate[index].totalTime,workingHourText,showCorrectonDialog);
  ...
  _showMHDialog(String dateStr,String firstHalfTime,String secondHalfTime,String workingHour,String attStatus,bool showCorrection){
    print(dateStr);
  ...
  _showCorrectionDialog(String dateStr,String firstHalfTime,String secondHalfTime,String workingHour,String attStatus){
    print(dateStr);
    print("Attendance Status :$attStatus");
    showModalBottomSheet(
        context: context,
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(child: InkWell(
                            onTap: (){
                              Navigator.of(context).pop();
                              Navigator.push(context, MaterialPageRoute(builder: (context) => ApplyShortLeave_Screen(dateStr)),);
                            },
                            child: Container(
                              height: 125,
                              decoration: BoxDecoration(
