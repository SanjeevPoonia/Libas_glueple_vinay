...
class ViewAttendanceLogs extends StatefulWidget{
  String dateStr;
  String checkIn;
  String checkOut;
  String workingHours;

  ViewAttendanceLogs(this.dateStr,this.checkIn,this.checkOut,this.workingHours, {super.key});
  _viewLogs createState()=>_viewLogs();
}
class _viewLogs extends State<ViewAttendanceLogs>{
  late var userIdStr;
  ...
  getAttendanceLogs() async {
    ...
    var response = await helper.getWithToken(baseUrl, 'admin/getAttendanceforHikVision?date=${widget.dateStr}&emp_id=$empId ', token, context);
    Navigator.pop(context);
