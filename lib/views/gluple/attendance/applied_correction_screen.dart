...
class AppliedCorrectionScreen extends StatefulWidget{
  _appliedCorrection createState()=>_appliedCorrection();
}
class _appliedCorrection extends State<AppliedCorrectionScreen>{
